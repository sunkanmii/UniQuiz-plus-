...
namespace Questionnaire_
{
        ...
        static Dictionary<string, bool> stopWords = new Dictionary<string, bool>
    {
        ...
        /// <summary>
        /// Removes all stop words from the string.
        /// </summary>
        /// <param name="input">Accepts input of type string.</param>
        /// <returns>Returns a new string with no stop words.</returns>
